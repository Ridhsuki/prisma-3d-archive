...
<div style="display: flex; flex-wrap: wrap; gap: 10px; justify-content: center; align-items: center;" align="center">
  <img alt="Screenshot proyek di aplikasi" height="400" style="margin: 9px;" src="z-assets/1.jpg" />
  <img alt="Screenshot proyek di aplikasi" height="400" style="margin: 9px;" src="z-assets/2.jpg" />
  <img alt="Screenshot proyek di aplikasi" height="400" style="margin: 9px;" src="z-assets/3.jpg" />
</div>
...
<div style="display: flex; flex-wrap: wrap; gap: 10px; justify-content: center; align-items: center;" align="center">
  <img width="400" alt="Langkah-langkah di ZArchiver 1" src="z-assets/4.jpg" />
  <img width="400" alt="Langkah-langkah di ZArchiver 2" src="z-assets/5.jpg" />
</div>
